...
class ExposureTVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let alert = UIAlertController(title: NSLocalizedString("Welcome!", comment: ""), message: NSLocalizedString("This app let's you track what you did during games, what champs (only a few) you've played, and how many kills, assists, and deaths you had in a game.", comment: ""), preferredStyle: .alert)
        ...
        self.title = NSLocalizedString("League of Legends kda tracker", comment: "")
    ...
    func deletionAlert(title: String, completion: @escaping (UIAlertAction) -> Void) {
        ...
        let alertMsg = NSLocalizedString("Are you sure you want to delete \(title)? This cannot be undone!", comment: "")
    ...
    @IBAction func onRight(_ sender: UISwipeGestureRecognizer) {
        print("registered")
    }
