...
class AddVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        MileageL.text = NSLocalizedString("Kills", comment: "")
        DurationL.text = NSLocalizedString("Deaths", comment: "")
        ContactL.text = NSLocalizedString("Assists", comment: "")
...
extension AddVC: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return ChampType.allCases.count
    }
    
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return ChampType(rawValue: row)?.title()
    }
